export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "FASHION"
export const APP_DESCRIPTION = process.env.NEXT_PUBLIC_APP_DESCRIPTION || "Fashion is an ecommerce website built with Nextjs, Tailwindcss and MongoDB"
