...
const Price = (field: string) =>
    z.coerce 
      ...
      .refine(
        ...
        `${field} must have exactly two decimal places (e.g., 13.23)`
      )
export const ProductInputSchema = z.object({
    ...
    numReviews: z.coerce
       .number()
       .int()
       .nonnegative('Number of reviews must be at least a non-negative number'),
...
numSales: z.coerce
   .number()
   .int()
   .nonnegative('Number of sales must a non-negative number'),
})
