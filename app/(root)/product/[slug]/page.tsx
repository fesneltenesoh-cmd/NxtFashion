   ...
   import { getProductBySlug, getProductsByCategory } from '@/lib/actions/productAction'
   ...
   import AddToBrowsingHistory from '@/components/products/addToBrowsingHistory'
   import AddToCart from '@/components/products/addToCart'
   import { generateId, rounded2Dp } from '@/lib/utils'
                ...
                <div className="flex justify-center items-center">
                  <AddToCart 
                    item={{
                      ...
                      slug: product.slug,
                      category: product.category,
                      price: rounded2Dp(product.price),
                      quantity: 1,
